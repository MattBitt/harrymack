...
#     return main.load_config(tmp_config_path)
...
#         main.copy_file(source_csv, correct_csv, overwrite=True)
#         correct_csv = main.keep_n_lines_of_file(n, correct_csv)
#         return correct_csv
#     else:
...
#     empty_csv = main.keep_n_lines_of_file(0, correct_csv)
#     return empty_csv


# @pytest.fixture
# def malformed_csv(correct_csv, tmp_path):
#     malformed_csv = main.remove_random_column_from_csv(correct_csv, tmp_path)
